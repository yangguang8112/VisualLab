...
class PipeRes(Base):
    ...
    CNV_Number = Column(Integer)
    CNV_DUP_Length = Column(Integer)
    CNV_DEL_Length = Column(Integer)
    CNV_Anno_Number = Column(Integer)
    SV_Number = Column(Integer)
    SV_Anno_Number = Column(Integer)
