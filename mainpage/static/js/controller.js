...
function get_r1_data() {
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var logKey in data) {
            // //将对应键值对取出存入test，logKey 为该字典的键
                test.push({value: data[logKey], name: logKey});
            }

            // var list1=$.json(data).json.list1;
            // var list2=$.json(data).json.list2;
            // var test = new Array();
            ...
            // }
             ...
             ec_right1_option.series[0].data=test;
